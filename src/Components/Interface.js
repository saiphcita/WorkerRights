...
class Interface extends Component {
  ...
  render() {
    var button = <button
                    style={{width:"142px", height:"100%", color:"black", backgroundColor:"#80cbc4", float:"right", border:"none", cursor:"pointer", padding:"0"}}
    ...
    if(this.state.statePage === "0" || this.state.statePage === ""){
        page = <div>
            <div className="linkGen" style={{width:"1340px", height:"78.2px", padding:"2px 0 4px 0"}}>
